// Override Asset list view so status shows Unallocated/Allocated (matches React app)
frappe.listview_settings["Asset"] = {
	...
	get_indicator: function (doc) {
		if (doc.status === "Fully Depreciated") {
			...
			return [__("Allocated"), "blue", "status,=,Submitted"];
		} else if (doc.status === "Draft" || doc.docstatus === 0) {
			return [__("Unallocated"), "red", "status,=,Draft"];
		}
	},
	onload: function (me) {
